...
ShaderProgram::ShaderProgram(const std::string_view &vertexCode, const std::string_view &fragmentCode)
{
...
void ShaderProgram::compileShader(const char* code, GLenum type, uint32_t &id)
{
...
void ShaderProgram::initRenderBuffers()
{
